 ...
 */
public class ArrowExpandSelectableHeaderHolder extends TreeNode.BaseNodeViewHolder<DeptNodeItem> {
    ...
    public View createNodeView(final TreeNode node, DeptNodeItem value) {
        ...
        iconView.setIconText(context.getResources().getString(/*value.icon*/R.string.ic_laptop));
