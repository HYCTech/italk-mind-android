...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        GetAddFrienditemDao.createTable(db, ifNotExists);
        MsgItemDao.createTable(db, ifNotExists);
        GroupItemDao.createTable(db, ifNotExists);
        ...
        SearchAddDao.createTable(db, ifNotExists);
        UserInfoDao.createTable(db, ifNotExists);
        ConversationDao.createTable(db, ifNotExists);
        ChatLogDao.createTable(db, ifNotExists);
        RequestTimeDao.createTable(db, ifNotExists);
        GroupMemberDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        GetAddFrienditemDao.dropTable(db, ifExists);
        MsgItemDao.dropTable(db, ifExists);
        GroupItemDao.dropTable(db, ifExists);
        ...
        SearchAddDao.dropTable(db, ifExists);
        UserInfoDao.dropTable(db, ifExists);
        ConversationDao.dropTable(db, ifExists);
        ChatLogDao.dropTable(db, ifExists);
        RequestTimeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(GetAddFrienditemDao.class);
        registerDaoClass(MsgItemDao.class);
        registerDaoClass(GroupItemDao.class);
        ...
        registerDaoClass(RequestTimeDao.class);
