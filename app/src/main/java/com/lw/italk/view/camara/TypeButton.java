package com.lw.italk.view.camara;
...
public class TypeButton extends View {
    ...
    public TypeButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.typebtn);
        int type = array.getInt(R.styleable.typebtn_type, 0);
        int size = array.getInt(R.styleable.typebtn_size, 0);
        init(type, size);
    }
