...
public class StatusBarUtil {
     ...
     */
    @SuppressLint("NewApi") public static void setColor(Activity activity, int color, int statusBarAlpha) {
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    @SuppressLint("NewApi") public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
     ...
     * @param drawerLayout DrawerLayout
     */
    @SuppressLint("NewApi") public static void setTransparentForDrawerLayout(Activity activity, DrawerLayout drawerLayout) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    @SuppressLint("NewApi") public static void setTranslucentForImageView(Activity activity, int statusBarAlpha, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    @SuppressLint("NewApi") public static void setBarAlpha(Activity activity, int statusBarAlpha) {
        activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        addTranslucentView(activity, statusBarAlpha);
    }
