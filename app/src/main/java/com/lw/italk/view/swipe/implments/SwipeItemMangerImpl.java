package com.lw.italk.view.swipe.implments;

import android.view.View;
import android.widget.BaseAdapter;

import com.lw.italk.view.swipe.SimpleSwipeListener;
import com.lw.italk.view.swipe.SwipeLayout;
import com.lw.italk.view.swipe.interfaces.SwipeAdapterInterface;
import com.lw.italk.view.swipe.interfaces.SwipeItemMangerInterface;
...
public class SwipeItemMangerImpl implements SwipeItemMangerInterface {
	...
	public SwipeItemMangerImpl(BaseAdapter adapter) {
		...
		if (!(adapter instanceof SwipeItemMangerInterface))
			throw new IllegalArgumentException(
					"adapter should implement the SwipeAdapterInterface");
	...
	private int getSwipeLayoutId(int position) {
		return ((SwipeAdapterInterface) (mAdapter))
