...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
	...
	public MediaObject setOutputDirectory(String key, String path) {
		path = App.getInstance().getExternalFilesDir(null).getPath() + File.separator + "external_files/";
...
//        }
	...
	public void startPreview() {
		Log.e("123qwe", "iv_back click startPreview:" + mStartPreview + ",mPrepared:" + mPrepared);
...
//            videoSize = CameraParamUtil.getInstance().getPreviewSize(params.getSupportedPreviewSizes(), 600,
//                    screenProp);
//        } else {
//            videoSize = CameraParamUtil.getInstance().getPreviewSize(params.getSupportedVideoSizes(), 600,
//                    screenProp);
//        }
//        Log.i("123qwe", "setVideoSize    width = " + videoSize.width + "height = " + videoSize.height);
...
//        }
		mMediaRecorder.setVideoEncodingBitRate(8 * 100000);
//        } else {
...
//        }
		...
		String videoFileName = "video_" + mStartTime + ".mp4";

		String saveVideoPath = App.getInstance().getExternalFilesDir(null).getPath() + File.separator + "external_files/";
		File savePath = new File(saveVideoPath);
		if (savePath == null || !savePath.exists()) {
			savePath.mkdirs();
		}
		String videoFileAbsPath = saveVideoPath  + videoFileName;
...
//        Log.e("123qwe", "startRecord isRecorder 0:" + isRecorder );
//        if (isRecorder) {
//            return;
//        }
//        if (mCamera == null) {
...
//        if (DeviceUtil.isHuaWeiRongyao()) {
		...
		try {
			mIsRecorder = true;
			Log.e("123qwe", "startRecord isRecorder:" + mIsRecorder );
...
//            }
	...
	//停止录像
	public void stopVideoRecord(StopRecordCallback callback) {
		Log.e("123qwe", "stopRecord isRecorder:" + mIsRecorder );
		if (!mIsRecorder) {
			return;
		}
		Log.e("123qwe", "stopRecord mediaRecorder:" + mMediaRecorder );
		if (mMediaRecorder != null) {
...
//                }
//                Log.e("123qwe", "stopRecord isShort:" + isShort );
//                return;
//            }
			doStopPreview();
			String videoFileName = "video_" + mStartTime + ".mp4";
			String fileName = App.getInstance().getExternalFilesDir(null).getPath() + File.separator + "external_files/" +videoFileName;
			Log.e("123qwe", "stopRecord fileName:" + fileName );
			if (callback != null) {
...
//			angle = DeviceUtils.getSensorAngle(values[0], values[1]);
		}
